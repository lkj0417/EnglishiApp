...
exports.generateSpeakingReport = generateSpeakingReport;
exports.generatePart1Questions = generatePart1Questions;
exports.generatePart3FollowUp = generatePart3FollowUp;
const openai_client_js_1 = require("../lib/openai-client.js");
async function generateSpeakingReport(params) {
...
Required JSON schema:
{
  ...
  "acoustic_summary": {
    ...
    const raw = await (0, openai_client_js_1.callLLM)({
        tier: 'high',
        messages: [
    ...
    return {
        ...
        topImprovements: (raw.top_improvements ?? []).map((imp) => ({
...
/** 生成 Part 1 题目集 */
async function generatePart1Questions(params) {
...
/** 动态生成 Part 3 追问 */
async function generatePart3FollowUp(params) {
...
//# sourceMappingURL=speaking.engine.js.map