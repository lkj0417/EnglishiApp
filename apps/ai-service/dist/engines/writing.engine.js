...
exports.critiqueWriting = critiqueWriting;
const openai_client_js_1 = require("../lib/openai-client.js");
async function critiqueWriting(params) {
...
Required JSON schema:
{
  ...
  "model_rewrite": {
    ...
    return {
        ...
        sentenceAnnotations: (raw.sentence_annotations ?? []).map((sa) => ({
...
//# sourceMappingURL=writing.engine.js.map