...
exports.generateReadingArticle = generateReadingArticle;
const openai_client_js_1 = require("../lib/openai-client.js");
const cefr_utils_1 = require("@englishi/cefr-utils");
async function generateReadingArticle(params) {
    const { ucl, interestDomain, topic } = params;
    const targetWords = (0, cefr_utils_1.calcTargetWordCount)(ucl.overallCefr);
    ...
    const recentTopics = ucl.recentTopics?.join(', ') ?? 'none';
...
Required JSON schema:
{
  ...
  "questions": [
    ...
    return {
        ...
        targetVocabulary: (raw.target_vocabulary ?? []).map((v) => ({
            word: v.word,
            phonetic: v.phonetic ?? '',
...
//# sourceMappingURL=reading.engine.js.map